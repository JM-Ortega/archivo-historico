...
# invocación; sin TTY ese trazo (aunque cacheado) sale por stdout y contamina check()/probe() de abajo,
# que comparan el `db-probe`/`installation-check` capturado contra un valor exacto ("INSTALL_COMPLETE 0").
